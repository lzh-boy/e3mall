...
<body>
			...
			<div class="login_box clear">
					...
					<ul>
						<form id="formlogin" method="post">
							...
							<li style="display: none;">
								...
								<span class="border">
									<input type="hidden" name="bgcode" id="bgcode" value="sfbest" class="loginText"> <em class="icon1" id="bgcode_em"></em>\
								</span>
								<span id="uNameErr"></span>
							</li>
							<li>
								<span class="title">手机/验证邮箱/用户名<font style="padding-left: 20px" class="error_line" color="#ff0000"></font></span>
								<span class="border" style="position: relative">
									...
									<input class="new-input1 new-color" tabindex="1" data-clear-btn="true" id="loginname" size="25" autocomplete="off" htmlescape="true" title="请输入用户名"> <em class="icon1" id="usernamelogo"></em>
							...
							<li class="m-t12">
								...
								<span class="border" style="position: relative">
									<input id="password" name="password" class="required" tabindex="2" type="password" value="" autocomplete="off"> <em class="icon2" id="passwordlogo"></em>
									<span style="position: absolute; font-size: 14px; left: 5px; top: 9px; display: none;" class="sfbest_password_place">密码</span>
								</span>
								<span id="sfbestPwdErr"></span></li>
							<div class="clear"></div>
							<li>
							...
							<li class="m-t5" id="btn_sub">
								...
								<input type="hidden" name="_eventId" value="submit"> <a href="javascript:void(0)" id="login_sub" class="login_btn">登录</a>
							</li>
							<div></div>
						</form>
					</ul>
				...
				<ul class="blink">
					<li class="p-f10">
						...
						<div>
							<a href="http://api2.e3mall.cn/unionlogin/qq/oauth/qq_login.php?returnUrl=http://www.e3mall.cn/" class="link">QQ</a>&nbsp;|&nbsp;
							<a href="https://api.weibo.com/oauth2/authorize?client_id=1800908332&amp;redirect_uri=https%3A%2F%2Fpassport.e3mall.cn%2Fcallback%2Fsina&amp;response_type=code&amp;state=&amp;display=?returnUrl=http://www.e3mall.cn/" class="link">新浪微博</a> &nbsp;|&nbsp;
							<a href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801198099&amp;redirect_uri=https%3A%2F%2Fpassport.e3mall.cn%2Fcallback%2Fqq&amp;response_type=code&amp;type=?returnUrl=http://www.e3mall.cn/" class="link">腾讯微博</a> &nbsp;|&nbsp;
							<a href="http://api2.e3mall.cn/unionlogin/alipay.php?returnUrl=http://www.e3mall.cn/" class="link">支付宝</a>
						</div>
					</li>
				</ul>
			</div>
	...
	<div class="footer">
		...
		<p>
			北京宜立方电子商务有限公司<br> 北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 宜立方商城 e3mall.cn 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
	<script type="text/javascript">
		...
		var LOGIN = {
			...
			doLogin : function() {
				$.post("/tb/user/login", $("#formlogin").serialize(), function( data) {
					if (data.status == 200) {
						jAlert('登录成功！', "提示", function() {
							if (redirectUrl == "") {
								// 登录成功, 跳转到门户页面
								location.href = "http://127.0.0.1:8082";
							} else {
								// 由子系统携带url登录成功, 跳转到子系统页面
