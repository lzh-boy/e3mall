...
<div class="orderMain">
	<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="广东省广州市天河区汽车客运站"/>
	</form>
	...
	<div class="orderCurr" style="display: block;">
	 ...
	 <div id="userInvoiceId" class="orderTbody">
	  <a name="userInvoice"></a>
	   <h3 class="orderTitle">
	   	发票信息：<span class="addrAlter" id="invoice_edit" onclick="invoice_edit()">[修改]</span>
	  </h3>
	  <div class="orderItem">
	...
	<div class="backToCart">
		<a style=" text-decoration:underline;" target="" href="http://127.0.0.1:8090/cart/cart.html">返回修改购物车</a>
	 </div>
		...
		<div class="orderItem">
			...
			<div class="orderTbl">
				...
				<div class="orderPInfo">
					<div class="pItem">
						<a href="http://127.0.0.1:8086/item/${cart.id}.html" target="_blank">
							<img src="${cart.image }" style="width: 60px;height: 60px;"/>
						</a>
					</div>
					<div class="pItem pGoods">
						<a href="http://127.0.0.1:8086/item/${cart.id}.html" target="_blank">${cart.title }</a>
					</div>
					<div class="pItem pPrice" style="position: relative; z-index: 99">
						¥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${cart.price / 100 }" />
					</div>
	    ...
	    <div id="priceitems" class="priceitem">
	      <dl class="fl">
	        ...
	        <dd>
	          <div>运费金额：</div>
	          <span class="priceArea">
	          	¥<span id="shopping_price">10</span>
	          </span>
	        </dd>
	        <dd>
	          <div>应付总额：</div>
