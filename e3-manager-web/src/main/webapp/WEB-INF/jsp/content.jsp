...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',split:false" style="width:250px;padding:5px">
            <ul id="contentCategoryTree" class="easyui-tree" data-options="url:'/tb/content/category/list',animate: true,lines:true,method : 'GET'">
            </ul>
        </div>
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,fitColumns:true,rownumbers:true,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/tb/content/query/list',queryParams:{categoryId:0}">
		    <thead>
		        <tr>
		            <th data-options="field:'id',width:30">ID</th>
		            <th data-options="field:'title',width:220">内容标题</th>
		            <th data-options="field:'subTitle',width:200">内容子标题</th>
		            <th data-options="field:'titleDesc',width:220">内容描述</th>
...
var contentListToolbar = [{
    ...
    handler:function(){
    	...
    	$.messager.confirm('确认','确定删除ID为 '+ids+' 的内容吗？',function(r){
    	    if (r){
    	    	var params = {"ids":ids};
            	$.post("/tb/content/delete",params, function(data){
        			if(data.status == 200){
